...
if(isset($_POST["submit"])){
    ...
    if($errors == []){
        ...
        $recap_transaksi = getData($conn, $sql_grafik);
        ...
        $total_transaksi = getData($conn, $sql_total)[0];
    }
...
<body>
    ...
    <div class="content">
        ...
        <div class="table-header">
            ...
            <a href="/2025-2026_Gasal_PAW_G/Modul-8/24-183_Mohammad_Jefri_Yusuf/index.php" class="btn btn-secondary">Kembali</a>
        </div>
        ...
        <table>
            ...
            <tr>
                <td><?= $num ?></td>
                <td>Rp<?= number_format($t['total_harian']) ?></td>
