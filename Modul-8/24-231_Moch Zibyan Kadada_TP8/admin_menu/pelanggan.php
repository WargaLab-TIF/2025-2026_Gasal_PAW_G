...
if(isset($_GET['aksi']) && $_GET['aksi'] == 'hapus' && isset($_GET['id'])) {
    ...
    if($hapus) {
        header("location:pelanggan.php?pesan=berhasil_hapus");
    } else {
...
<body>
<div class="container">
    <h2>Data Master Pelanggan</h2>
    
    <?php 
    if(isset($_GET['pesan'])){
        if($_GET['pesan'] == "berhasil_tambah"){
            echo "<div class='alert alert-success'>Data pelanggan berhasil ditambahkan!</div>";
        }else if($_GET['pesan'] == "berhasil_edit"){
            echo "<div class='alert alert-success'>Data pelanggan berhasil diubah!</div>";
            ...
            echo "<div class='alert alert-danger'>Data pelanggan gagal dihapus.</div>";
        }
    }
    ?>
    
    <div class="btn-container">
        <a href="pelanggan_tambah.php" class="btn btn-primary">Tambah Data Pelanggan</a>
    ...
    <table class="content-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="pelanggan_edit.php?id=<?php echo $d['id_pelanggan']; ?>" class="btn btn-warning">Edit</a>
                    <a href="pelanggan.php?aksi=hapus&id=<?php echo $d['id_pelanggan']; ?>" 
                       onclick="return confirm('Yakin ingin menghapus pelanggan <?php echo $d['nama_pelanggan']; ?>?')" class="btn btn-danger">Hapus</a>
                </td>
            </tr>
            <?php 
                } 
