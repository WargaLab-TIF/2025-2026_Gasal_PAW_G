...
function validatePel(&$error, $field)
{
    $query = "SELECT * FROM transaksi WHERE pelanggan_id = '$field'";
    $conn = mysqli_connect("localhost", "root", "", "penjualan");
    $result = mysqli_query($conn, $query);
    if (mysqli_num_rows($result)) {
        $error['pelanggan'] = "Transaksi pelanggan tersebut sudah ada";
    }
}
$error = [];
$waktu = $_POST['waktu'] ?? "";
...
if (isset($_POST['tambah'])) {
    ...
    validatePel($error, $id_pelanggan);
}
?>
...
<body>
    ...
    <form action="transaksi.php" method="post">
        ...
        <table border="0">
            ...
            <tr style="height: 10px;"></tr>
            <tr>
                <td><input type="submit" name="tambah" value="Tambah Transaksi" style="width: 304px;" class="tambah"></td>
            </tr>
        </table>
    </form>
</body>
